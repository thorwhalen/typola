...
|------------------------------------------------------------------------|-----------------------------------------------------------------|
| `list_sources`()                                                       |                                                                 |
| [`register_source`](#typola.sources.base.register_source)(spec) | Register a source so `get_source` and `load(name)` can find it. |

### Classes

| [`SourceSpec`](#typola.sources.base.SourceSpec)(name, url[, citation, license, ...])   | Describe a typology dataset that can be loaded into a `Typology`.   |
|----------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
...
* **Return type:**
  [`SourceSpec`](#typola.sources.base.SourceSpec)
