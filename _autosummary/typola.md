...
* **Parameters:**
  * **name_or_spec** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str) | [`SourceSpec`](typola.sources.base.md#typola.sources.base.SourceSpec)) – The registered name (e.g. `"wals"`) or a spec object.
...
* **Parameters:**
  * **typology** ([`Typology`](typola.prep.canonical.md#typola.prep.canonical.Typology))
  ...
  * **estimator** ([`Estimator`](typola.estimators.base.md#typola.estimators.base.Estimator) | [`None`](https://docs.python.org/3/builtins/constants.html#None)) – Count-to-probability strategy. Defaults to Jeffreys.
* **Return type:**
  [`Distribution`](typola.models.distribution.md#typola.models.distribution.Distribution) | [`Conditional`](typola.models.conditional.md#typola.models.conditional.Conditional)
* **Returns:**
...
| [`sources`](typola.sources.md#module-typola.sources)       | Descriptors and downloaders for typology datasets.   |
|--------------------------------------------------------------------------------------|------------------------------------------------------|
| [`estimators`](typola.estimators.md#module-typola.estimators) | Pluggable count-to-probability estimators.           |
| [`data_dir`](typola.data_dir.md#module-typola.data_dir)     | User-data directory resolution.                      |
| [`models`](typola.models.md#module-typola.models)         | Probabilistic models over a `Typology`.              |
| [`prep`](typola.prep.md#module-typola.prep)             | Data preparation: raw source → canonical `Typology`. |
