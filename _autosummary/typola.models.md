...
| [`conditional`](typola.models.conditional.md#module-typola.models.conditional)   | Conditional distribution: P(target parameter | given parameter).     |
|-------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|
| [`distribution`](typola.models.distribution.md#module-typola.models.distribution) | A categorical distribution over a known support, with introspection. |
| [`marginal`](typola.models.marginal.md#module-typola.models.marginal)         | Marginal distribution over a parameter's support, under a condition. |
