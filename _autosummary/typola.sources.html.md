...
* **Return type:**
  [`SourceSpec`](typola.sources.base.html.md#typola.sources.base.SourceSpec)

### Modules

| [`base`](typola.sources.base.html.md#module-typola.sources.base)       | Source specification & registry.        |
|----------------------------------------------------------------------------------------|-----------------------------------------|
| [`catalog`](typola.sources.catalog.html.md#module-typola.sources.catalog) | Catalog of known typology data sources. |
